...
?>
    ...
    <div class="container">
        ...
        <section id="popular-artworks" class="py-5">
            <div class="container">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h2 class="section-title mb-0">Which Artwork Calls to You?</h2>
                    <a href="artworks.php" class="btn btn-sm btn-outline-secondary">Browse All</a>
                </div>
                <p class="section-subtitle">Discover masterpieces from our extensive collection across all galleries.</p>
                        ...
                        if ($artworks) {
                            foreach ($artworks as $artwork) {
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-footer">
                                        <a href="artworks.php?id=<?php echo $artwork['artwork_id']; ?>" class="btn btn-primary" style="padding: 0.5rem 1rem; font-size: 0.9rem;">View Artwork</a>
                                    </div>
                                </div>
                                <?php
                            }
