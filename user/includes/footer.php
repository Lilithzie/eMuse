    ...
    <footer class="footer">
        <div class="footer-container">
            ...
            <div class="footer-section">
                ...
                <p><strong>Email:</strong><br><a href="mailto:eMuseoficial@gmailmuseum" style="padding-left: 0;">eMuseoficial@gmailmuseum</a></p>
        ...
        <div class="footer-bottom">
            <p>&copy; 2026 eMuse Museum Management System. All rights reserved.</p>
        </div>
    </footer>
</body>
</html>
